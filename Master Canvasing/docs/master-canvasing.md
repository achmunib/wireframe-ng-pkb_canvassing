...
|--------------|----------------|----------|-----------------|-----------|-----|-------------------|--------|------------|------------|
|              |                |          |                 |           |     |                   |        |            |            |
| LOV-Mekanik | LIST OF VIEW | Menampilkan daftar mekanik beserta status penugasannya | Nilai awal: **"Pilih Mekanik..."**<br><br>Format pilihan mekanik: <br> * Mekanik sedang bekerja → `<Nama> (<Stall> - Sedang Mengerjakan PKB <No. PKB>)` <br> * Mekanik tersedia → `<Nama> (<Stall> - Available / Siap Ditugaskan)`<br><br>Jika user memilih mekanik yang sedang mengerjakan PKB lain, tombol **Next otomatis menjadi disable** (tanpa banner notifikasi tambahan di bawah dropdown maupun banner validasi terpisah).<br><br>**Catatan pengembangan:** daftar mekanik dan statusnya masih hardcode, perlu di-binding ke master mekanik dan status PKB berjalan | Yes | | | | | |
